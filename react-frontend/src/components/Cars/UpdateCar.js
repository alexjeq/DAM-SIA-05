...
class UpdateCar extends Component {
    ...
    componentDidMount() {
        CarsService.getCarById(this.state.id).then(res => {
            this.setState({
                ...
                fuel_type: res.data.combustibil != null ? fuelTypes.filter(e => e.label.toLowerCase() == res.data.combustibil.toLowerCase())[0] : null,
                register_date: res.data.dataInmatriculare != null ? new Date(res.data.dataInmatriculare) : null,
    ...
    updateCar = () => {
        ...
        CarsService.updateCar(payload, this.state.id).then(res => {
